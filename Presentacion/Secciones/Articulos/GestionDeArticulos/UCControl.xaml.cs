...
namespace Sistema.Presentacion.Secciones.Articulos.GestionDeArticulos
{
    /// <summary>
    ...
    public class Controlador : ControladorDeSeccion
    {
        ...
        {
            TituloGeneral = "Gestión de artículos";
        ...
        public override List<ICommand> IComandos => new List<ICommand> {
            ...
            new Comando( () =>
            {
               var c =new   Sistema.Presentacion.Secciones.Articulos.GestionDeArticulos.Principal.Controlador(this.Articulo);
